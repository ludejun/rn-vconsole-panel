...
export const DeviceBoard = (props) => {
    ...
    const data = {
        ...
        model: Platform.OS === 'ios'
            ? 'iPhone'
            : `${(_b = Platform.constants) === null || _b === void 0 ? void 0 : _b.Manufacturer}/${(_c = Platform.constants) === null || _c === void 0 ? void 0 : _c.Brand}/${(_d = Platform.constants) === null || _d === void 0 ? void 0 : _d.Model}`,
    ...
    return (<View style={defaultStyle.container}>
      <ScrollView ref={sc}>
        ...
        {definedData
            ? Object.keys(definedData).map((key) => (<View key={key} style={defaultStyle.item}>
                <View style={defaultStyle.left}>
                  <Text>{key}</Text>
                </View>
                <View style={defaultStyle.right}>
