...
export const DeviceBoard = (props: DeviceBoard) => {
  ...
  const data = {
    ...
    model: Platform.OS === 'ios' ? 'iPhone' : `${Platform.constants?.Manufacturer}/${Platform.constants?.Brand}/${Platform.constants?.Model}`,
  ...
  return (
    <View style={defaultStyle.container}>
      ...
      {
        definedData ? Object.keys(definedData).map(key => (
            <View key={key} style={defaultStyle.item}>
              <View style={defaultStyle.left}><Text>{key}</Text></View>
